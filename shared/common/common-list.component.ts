...
import { AuthUserPermissions } from 'src/app/models/auth-user-permission';
...
export abstract class CommonListComponent {
  ...
  public authPermission: AuthUserPermissions = null;

  public sortIconName = 'arrow_drop_up'; 
 ...
 */
    ...
    .pipe(
      map(res => {
        ...
        catchError(error => {
          ...
          this.errorMsgLoading = error;//this.txt.messages.error + ' - ' + error;
          // flag de carregamento
          this.loading = false;
   ...
   */
  protected _delete(id:any, service:CommonService, param1?:any, param2?:any): void {
        ...
        service.deleteData(id, ...param1, ...param2) // param -> (parametros adicionais, opcionais)
          .subscribe(
            res => {
              ...
              this.snackBar.openSnackBar(this.txt.messages.deleted, 'Ok', 'green-snackbar');
